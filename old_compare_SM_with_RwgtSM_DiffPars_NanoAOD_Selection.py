...
#tfile_SM = r.TFile("/eos/cms/store/user/jlawhorn/WVJJTree_Jun20/2017/WminusTo2JZTo2LJJ_EWK_LO_SM_MJJ100PTJ10_TuneCP5_13TeV-madgraph-pythia8.root")
...
#if(vbf1_AK4_pt > 50):
tree_OnlyFT1_initialize.Draw(aQGC,"59.0*17.92*aqgcWeight[25]*"+"("+args.cut+")","")
tree_OnlyFT1_initialize.Draw(FT5,"59.0*17.92*aqgcWeight[134]*"+"("+args.cut+")","")
tree_OnlyFT1_initialize.Draw(Reweight,"59.0*17.92*aqgcWeight[35]*"+"("+args.cut+")","")
tree_SM.Draw(SM,"59.0*0.9107*"+"("+args.cut+")","")
#else:
